...
interface FlashcardSectionDesktopProps {
    productId: string;
}

export const FlashcardSectionDesktop = ({ productId }: FlashcardSectionDesktopProps) => {
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                <motion.button
                                    ...
                                    className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${shuffleMode
